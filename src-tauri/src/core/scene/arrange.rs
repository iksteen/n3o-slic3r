...
use super::state::{ObjectId, SceneObject, SceneState};
...
mod tests {
    ...
    fn add_n_cubes(state: &mut SceneState, n: usize, edge: f32) {
        for _ in 0..n {
    ...
    fn footprints_overlap_after_plan(plan: &ArrangeResult, state: &SceneState) -> bool {
