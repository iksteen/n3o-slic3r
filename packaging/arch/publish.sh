...
#                          commands). Default: https://n3o.thegraveyard.org/arch
#   N3O_ARCH_PUBLISH_DEST  Optional rsync/ssh destination, e.g.
#                          user@host:/srv/www/n3o.thegraveyard.org/arch.
...
url="${N3O_ARCH_URL:-https://n3o.thegraveyard.org/arch}"
url="${url%/}"
...
user@host:/srv/www/n3o.thegraveyard.org/arch) to upload automatically,
or by hand:
  rsync -a "${pkg}" "${sig}" your-server:/srv/www/n3o.thegraveyard.org/arch/
  rsync -a "${keyfile}" your-server:/srv/www/n3o.thegraveyard.org/arch/
DONE
fi
