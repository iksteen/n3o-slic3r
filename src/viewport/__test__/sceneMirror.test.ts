...
describe("SceneMirror spool-color paint", () => {
  ...
  it("Snappy: object routed to a higher-extruder slot paints with that extruder's color", async () => {
    ...
    const snappy: PrinterInstance = {
      ...
      connection: null,
      extruders: [
        { installed_nozzle: { diameter: "0.4", material: "stainless" }, slots: [{ feed: "direct", filament_identity: "generic-pla", color: "#dc2626" }] },
        { installed_nozzle: { diameter: "0.4", material: "stainless" }, slots: [{ feed: "direct", filament_identity: "generic-pla", color: "#eab308" }] },
        { installed_nozzle: { diameter: "0.4", material: "stainless" }, slots: [{ feed: "direct", filament_identity: "generic-pla", color: "#111827" }] },
        { installed_nozzle: { diameter: "0.4", material: "stainless" }, slots: [{ feed: "direct", filament_identity: "generic-pla", color: "#f8fafc" }] },
      ],
