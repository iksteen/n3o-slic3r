...
`docs/phase-3-smoke.md` / `phase-2-smoke.md` / `phase-1-smoke.md` /
`phase-0-smoke.md`.
...
- `docs/phase-4-smoke.md` documents:
...
the production panel visually matches `docs/design/index.html`
(or the standalone bundle) on the relevant surfaces:

- Settings row left-edge **rule** appears on hover with the
  winning layer's hue (palette from `docs/design/data.jsx`:
