...
|-------------|--------|--------|
| Schema generator (libslic3r option introspection → typed Rust) | ❌ open | [PR-1-1](phase-1/PR-1-1%20Schema%20generator.md) |
| TOML cascade loader + parser + load-time validation | ❌ open | [PR-1-2](phase-1/PR-1-2%20Cascade%20loader%20and%20parser.md) |
