...
Status: ✅ done. Procedure documented at `docs/phase-0-smoke.md`.
...
- `docs/phase-0-smoke.md` documents the smoke procedure:
...
That constraint is now encoded in `docs/Execution_Plan.md` Spike 1,
`docs/profiles.md` "What stays libslic3r-shaped", and the Phase 0.5
PR-0.5-1 ticket.
