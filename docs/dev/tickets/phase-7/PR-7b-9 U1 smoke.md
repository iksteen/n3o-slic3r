...
Status: ✅ done. Walkthrough doc landed at `docs/dev/phase-7b-smoke.md`; recorded validation runs against live U1 hardware.
...
- **Walkthrough doc** `docs/dev/phase-7b-smoke.md`:
