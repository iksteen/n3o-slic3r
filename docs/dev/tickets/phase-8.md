...
pipeline without touching Rust." Source: `docs/dev/Execution_Plan.md` §10,
...
2. **platecycler is a post-slice macro append, not a multi-plate
   ...
   `docs/dev/spikes/spike-5-platecycler.md`) to the **tail of a single
...
> **exit smoke** (`docs/dev/phase-8-smoke.md` + automated chain in
...
(`docs/dev/phase-8-smoke.md`; `phase_8_exit_smoke` +
...
- **`docs/dev/Execution_Plan.md` §16** — add compose hook + multi-plate
