...
Source: `docs/dev/Execution_Plan.md` §4. Stated goal:
...
| STL + OBJ loaders | ✅ done | [PR-2-3](phase-2/PR-2-3%20STL%20and%20OBJ%20loaders.md) (Stormtrooper Helmet perf fixture is user-staged at runtime; CC-BY-NC, see `docs/dev/phase-2-smoke.md`) |
...
- **Seeded / quality profiles** — explicitly post-MVP per
  `docs/dev/PRD.addendum.01.Seeded-Profiles.md`. Slots into the
