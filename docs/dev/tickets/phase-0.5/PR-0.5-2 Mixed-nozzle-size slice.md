...
Status: ✅ done. Finding doc: `docs/dev/spikes/spike-2-mixed-nozzle.md`. Mixed-nozzle config validated here; toolchange-emission criterion was deferred to and confirmed by PR-0.5-3 (76 mid-print tool changes in its 4-color slice).
...
- The output gcode is captured at `/tmp/spike2.gcode` and inspected
  ...
  - independent retraction/wipe settings per tool (or a documented
    ...
    profile).
- The finding doc at `docs/dev/spikes/spike-2-mixed-nozzle.md` records:
