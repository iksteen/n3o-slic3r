...
cascade-aware settings" claim. Source: `docs/dev/Execution_Plan.md`
§7. Stated goal:
...
`docs/dev/design/`'s mockup carries Phase 5 surfaces:

- **`docs/dev/design/PlateTabs.jsx`** is the canonical reference for
...
- **`docs/dev/design/app.jsx`** at the `App` component is the
