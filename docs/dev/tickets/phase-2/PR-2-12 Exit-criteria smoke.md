...
Status: ✅ shipped — automated half lives in `tests/phase2_smoke.rs` + `npm test`; human-driven viewport half in `docs/dev/phase-2-smoke.md`.
...
- `docs/dev/phase-2-smoke.md` documents the procedure:
