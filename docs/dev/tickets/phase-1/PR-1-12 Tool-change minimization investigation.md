...
skip, not in libslic3r itself. See `docs/dev/spikes/spike-3-bambu-ams.md`
...
prerequisite framing from `docs/dev/spikes/spike-3-bambu-ams.md`
holds.
...
- Whatever the investigation surfaces, the fix lives in
  ...
  engine-invocation quirk, per the `docs/dev/libslic3r-workarounds.md`
...
- Update `docs/dev/spikes/spike-3-bambu-ams.md` "Investigation so far"
