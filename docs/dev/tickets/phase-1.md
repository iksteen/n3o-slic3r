...
`docs/dev/profiles.md` and §6.1 / §8.2 of the PRD. By the end of the
...
Source: `docs/dev/Execution_Plan.md` §3. Stated goal:
...
- **PR-0.5-3** (Bambu AMS): the `.gcode.3mf` wrapper sits *above*
  ...
  unresolved — see `docs/dev/spikes/spike-3-bambu-ams.md`. Phase 1
...
| Phase 1 exit-criteria smoke | ⚠️ partial | [PR-1-11](phase-1/PR-1-11%20Exit-criteria%20smoke.md) (smoke binary + docs/dev/phase-1-smoke.md; validation-errors example + CI hook + benchmark wiring deferred) |
