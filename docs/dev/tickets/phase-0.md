...
Source: `docs/dev/Execution_Plan.md` §2. Stated exit criteria:
...
`docs/dev/tickets/phase-0.5.md` and its `phase-0.5/` ticket directory.
...
the dispatch-quirk normalizations listed in `docs/dev/profiles.md`
