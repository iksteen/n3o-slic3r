...
> `docs/dev/phase-8-platecycler-smoke.md`.

A single repeatable gate chaining Phase 8's exit criteria
(`Execution_Plan.md` §10, adjusted in `docs/dev/tickets/phase-8.md`). It
...
| 6 | The **platecycler** plugin auto-ejects the finished plate on real A1 mini + PlateCycler hardware. | `docs/dev/phase-8-platecycler-smoke.md` (hardware) |
