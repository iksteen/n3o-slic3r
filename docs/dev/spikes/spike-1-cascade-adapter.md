...
The cascade-adapter pattern described in `docs/dev/profiles.md` works
...
`docs/dev/profiles.md` "three equivalent forms"; the converter and
...
`docs/dev/profiles.md` "Translating to libslic3r" → "Dimensional
...
- **Phase 1 (Rule cascade + adapter).** Proceed as planned. The
  ...
  per-plate-type dimensional expansion. Pull `docs/dev/profiles.md`'s
...
described in `docs/dev/profiles.md` and PRD §6.1 / §8.2 is validated.
