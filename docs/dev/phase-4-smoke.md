...
against the docs/dev/design/ mockup until App.tsx integration lands:

1. **Tweaks vs deliverables.** Open
   `docs/dev/design/n3o-slic3r-standalone.html` in a browser. Confirm
...
- **Panel mismatched with mockup:** open `docs/dev/design/index.html`
